...
vault write cubbyhole/rocket/drax secretflag="123-456-7890"
vault login root
vault kv put secret/drax/left/clue/here path=cubbyhole/rocket/drax cubbyholeloginkey=$(cat cubbyhole_secret)

# Dummy keys
vault kv put secret/galaxy/user/key secretflag=deadend
vault kv put secret/galaxy/user/key1 secretflag=anotherdeadend
